...
class Movement: #The Movement Class for moving the robot; assign a variable to use
    def __init__(self):
        ...
        self.outpins = [[27, [5,6]], [13, [19,26]]] #sub-arrays with the Input and Direction pins for both left and right
        IO.setup([self.outpins[0][0]] + self.outpins[0][1] + [self.outpins[1][0]] + self.outpins[1][1], IO.OUT) #Setting up every pin as an output
